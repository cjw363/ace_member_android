...
public class RListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mArrowImageView = (ImageView) findViewById(R.id.lv_header_arrow);
	...
	public void setState(int state) {
		...
		switch (state) {
			case STATE_NORMAL:
				...
				mHintTextView.setText(R.string.drop_dow_refresh);
				break;
			case STATE_READY:
				if (mState != STATE_READY) {
					mArrowImageView.clearAnimation();
					mArrowImageView.startAnimation(mRotateUpAnim);
					mHintTextView.setText(R.string.loosen_refresh_data);
				}
				break;
			case STATE_REFRESHING:
				mHintTextView.setText(R.string.refresh_loading);
				break;
			default:
		}
