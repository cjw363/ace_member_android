...
public class CustomSlidingRefreshListView extends ListView implements AbsListView.OnScrollListener {
	...
	public CustomSlidingRefreshListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public CustomSlidingRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public CustomSlidingRefreshListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(Context context) {
		...
		mHeaderViewContent = (RelativeLayout) mHeaderView.findViewById(R.id.lv_header_content);
		mHeaderTimeView = (TextView) mHeaderView.findViewById(R.id.lv_header_time);
	...
	public void setAdapter(ListAdapter adapter) {
		//make sure RListViewFooter is the last footer view,and only add once.
