...
public class DPCalendar {
     ...
     * @return ...
     */
    public boolean isExceedToday(int year, int month, int day) {
        Calendar c1 = Calendar.getInstance();
        Calendar c2 = Calendar.getInstance();
        c1.set(year, month - 1, day);
        return (c1.get(Calendar.YEAR) > c2.get(Calendar.YEAR))||((c1.get(Calendar.YEAR) == c2.get(Calendar.YEAR)) &&(c1.get(Calendar.MONTH) > (c2.get(Calendar.MONTH))))||(c1.get(Calendar.YEAR) == c2.get(Calendar.YEAR)) &&(c1.get(Calendar.MONTH) == (c2.get(Calendar.MONTH))) &&(c1.get(Calendar.DAY_OF_MONTH) > c2.get(Calendar.DAY_OF_MONTH));
    }
