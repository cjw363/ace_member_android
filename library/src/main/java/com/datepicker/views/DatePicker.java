...
public class DatePicker extends LinearLayout {
	...
	public DatePicker(Context context, String date) {
		this(context, null, date);
	}

	public DatePicker(Context context, AttributeSet attrs, String date) {
		super(context, attrs);
		mTManager = DPTManager.getInstance();
		mLManager = DPLManager.getInstance(getContext());
		...
		RelativeLayout.LayoutParams lpEnsure = new RelativeLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
		...
		// ------------------------------------------------------------------------------------月视图
		monthView = new MonthView(context, date);
