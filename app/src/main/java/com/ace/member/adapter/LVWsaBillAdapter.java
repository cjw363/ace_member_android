...
public class LVWsaBillAdapter extends BaseAdapter {
	private LayoutInflater mInflater;
	private List<WsaBill> mList;

	public LVWsaBillAdapter(Context context, List<WsaBill> list) {
	...
	public void addList(List<WsaBill> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		try {
			ViewHolder holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.view_wsa_item, null);
