package com.ace.member.view.Badge;
...
public class QBadgeView extends View implements Badge {
  ...
  private void init() {
    ...
    mBadgeTextSize = Utils.dip2px(11);
    mBadgePadding = Utils.dip2px(5);
    mBadgeNumber = 0;
    mBadgeGravity = Gravity.END | Gravity.TOP;
    mGravityOffsetX = Utils.dip2px(1);
    mGravityOffsetY = Utils.dip2px(1);
    mFinalDragDistance = Utils.dip2px(90);
    mShowShadow = true;
  ...
  protected Bitmap createBadgeBitmap() {
    Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + Utils.dip2px(3),
      (int) mBadgeBackgroundRect.height() + Utils.dip2px(3), Bitmap.Config.ARGB_8888);
  ...
  private void showShadowImpl(boolean showShadow) {
    int x = Utils.dip2px(1);
    int y = Utils.dip2px(1.5f);
    ...
    mBadgeBackgroundPaint.setShadowLayer(showShadow ? Utils.dip2px(2f)
      : 0, x, y, 0x33000000);
  }
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (mBadgeText != null) {
      ...
      if (mDraggable && mDragging) {
        ...
        if (mDragOutOfRange = startCircleRadius < Utils.dip2px(1.5f)) {
  ...
  public Badge stroke(int color, float width, boolean isDpValue) {
    ...
    mBackgroundBorderWidth = isDpValue ? Utils.dip2px(width) : width;
    invalidate();
    return this;
  }
  ...
  public Badge setBadgeTextSize(float size, boolean isSpValue) {
    mBadgeTextSize = isSpValue ? Utils.dip2px(size) : size;
    measureText();
    invalidate();
    return this;
  }
  ...
  public float getBadgeTextSize(boolean isSpValue) {
    return isSpValue ? Utils.px2dp(mBadgeTextSize) : mBadgeTextSize;
  }

  @Override
  public Badge setBadgePadding(float padding, boolean isDpValue) {
    mBadgePadding = isDpValue ? Utils.dip2px(padding) : padding;
    createClipLayer();
    invalidate();
    return this;
  }
  ...
  public float getBadgePadding(boolean isDpValue) {
    return isDpValue ? Utils.px2dp(mBadgePadding) : mBadgePadding;
  }
  ...
  public Badge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
    mGravityOffsetX = isDpValue ? Utils.dip2px(offsetX) : offsetX;
    mGravityOffsetY = isDpValue ? Utils.dip2px(offsetY) : offsetY;
    invalidate();
    return this;
  }
  ...
  public float getGravityOffsetX(boolean isDpValue) {
    return isDpValue ? Utils.px2dp(mGravityOffsetX) : mGravityOffsetX;
  }

  @Override
  public float getGravityOffsetY(boolean isDpValue) {
    return isDpValue ? Utils.px2dp(mGravityOffsetY) : mGravityOffsetY;
  }
