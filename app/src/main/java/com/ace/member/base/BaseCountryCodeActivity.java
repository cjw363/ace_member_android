...
//TODO,该类不应该作为父类，还有一个相似功能是Currency的选取
public abstract class BaseCountryCodeActivity extends BaseActivity {
	...
	public void showCountryCode(final TextView textView) {
		try {
			...
			BottomDialog.Builder builder = new BottomDialog.Builder(this).setTvTitle(Utils.getString(R.string.area_code_type))
				.setTvContent1(tvContent1)
				.setTvContent2(tvContent2)
				.setIvRes(codeRes)
